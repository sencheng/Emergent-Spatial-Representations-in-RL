...
from custom_modules.observations.noise_module import NoiseInjection
...
if action_space == "Egocentric" : 
    ...
    network = "../../networks/egocentric_network_noise.json"
else : 
    save_path = 'guidance_allocentric'
    network = "../../networks/allocentric_network_noise.json"
...
def single_run():
    ...
    noise_input = NoiseInjection(main_window)
